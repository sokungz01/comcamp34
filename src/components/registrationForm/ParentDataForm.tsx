   ...
   return (
      <>
         <div className='bg-red1 bg-opacity-10 w-full rounded-xl flex flex-col font-bai-jamjuree px-16 py-4 mx-8'>
            ...
            <div className='flex mt-4 '>
               ...
               <div className='flex flex-row w-5/6'>
                  <div className='mx-2 w-full'>
                     <Inputbox label='ชื่อ' name='parent_fname' placeholder='ธนาธร' required obj={parent_fname} setObj={setparent_fname} />
                  </div>
                  <div className='mx-2 w-full'>
                     <Inputbox label='ชื่อกลาง (ถ้ามี)' name='parent_mname' placeholder='' required obj={parent_mname} setObj={setparent_mname} />
                  </div>
                  <div className='mx-2 w-full'>
                     <Inputbox label='นามสกุล' name='parent_sname' placeholder='' required obj={parent_sname} setObj={setparent_sname}/>
                  </div>
               </div>
            </div>
            <div className='flex  mt-2'>
               <div className='flex justify-between'>
                  ...
                  <div className='w-full ml-2'>
                     <TelInput label='เบอร์โทรศัพท์' name='parent_mobile' placeholder='' required obj={parent_mobile} setobj={setparent_mobile}/>
                  </div>
                  <div className='w-full ml-2'>
                     <EmailInput label='Email' name='parent_email' placeholder='' obj={parent_email} setObj={setparent_email}/>
                  </div>
               </div>
            </div>
            ...
            <h4 className='text-4xl text-red2 font-semibold mb-2'> ผู้ปกครองที่ติดต่อได้ในกรณีฉุกเฉิน </h4>
            <div className='flex mt-4'>
               <p className='mr-2'> เหมือนกับผู้ปกครอง </p>
               <CheckboxInput onclick={()=>(sameParent ? setsameParent(false) : setsameParent(true))} setobj={setsameParent} obj={sameParent} name='same_parent' label=' ' />
               <p className='ml-2'> </p>
            </div>
            <div className='flex mt-4'>
               <div className='w-1/6 mr-2'>
               ...
               <div className='flex flex-row w-5/6'>
                  <div className='mx-2 w-full'>
                     <Inputbox label='ชื่อ' name='emergency_fname' placeholder='ธนาธร' required  setObj={setemergency_fname} obj={emergency_fname} />
                  </div>
                  <div className='mx-2 w-full'>
                     <Inputbox label='ชื่อกลาง (ถ้ามี)' name='emergency_mname' placeholder='' required setObj={setemergency_mname} obj={emergency_mname}/>
                  </div>
                  <div className='mx-2 w-full'>
                     <Inputbox label='นามสกุล' name='emergency_sname' placeholder='' required setObj={setemergency_sname} obj={emergency_sname} />
                  </div>
               </div>
            </div>
            <div className='flex  mt-2'>
                  ...
                  <div className='w-full ml-2'>
                     <TelInput label='เบอร์โทรศัพท์' name='emergency_mobile' placeholder='' required setobj={setemergency_mobile} obj={emergency_mobile} />
                  </div>   
                  <div className='w-full ml-2'>
                     <EmailInput label='Email' name='emergency_email' placeholder='' setObj={setemergency_email} obj={emergency_email}/>
                  </div>   
               </div>
            </div>
