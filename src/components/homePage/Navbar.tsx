                  ...
                  <div>
                     ...
                     > */}
                       <button 
                           ...
                           className={`inline-block lg:text-xl lg:font-normal px-8 py-1 leading-none text-red2 lg:hover:bg-red2 lg:border-2 lg:border-red2 hover:border-transparent lg:hover:text-base-white bg-base-white mt-4 lg:mt-0 rounded-xl `}>
                        Register
                       </button>
                     {/* </Link> */}
                  </div>
