                     ...
                     <div className='font-bai-jamjuree xl:text-3xl md:text-2xl text-sm text-black flex flex-row mt-2'>
                        <div>
                           <div className='flex flex-row items-center'>
                              <a
                                 href='https://www.facebook.com/KMUTTcomcamp'
                                 target='_blank'
                              ...
                              >
                                 ...
                                 <p className="ml-2 lg:ml-3">Comcamp KMUTT</p>
                              </a>
                           </div>
                           <div className='flex flex-row items-center'>
                              <a
                                 href='https://www.instagram.com/comcamp.kmutt/'
                                 target='_blank'
                                 className='flex items-center'
                              >
                                 <svg
                           ...
                           <div className='flex flex-row items-center'>
                              <a
                                 href='https://www.tiktok.com/@comcamp.kmutt'
                                 target='_blank'
                                 className='flex items-center'
                              >
                                 <svg
